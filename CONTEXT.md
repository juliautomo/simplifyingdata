...
### Pending
- ⏳ Lemon Squeezy webhook not yet verified working — `wearcada@gmail.com` purchase didn't provision (debug in AI Biz session)
- ⏳ Supabase redirect URL needs adding: `https://bizanalyst.vercel.app` (Auth → URL Configuration)
- ⏳ Supabase invite email template — customize to say "Welcome to BizAnalyst AI"
